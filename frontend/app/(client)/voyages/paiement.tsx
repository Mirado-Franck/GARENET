...
export default function Paiement() {
  ...
  const handlePayment = async () => {
    ...
    // Validation du numéro MVola (format Madagascar)
    const numeroNormalized = numeroMvola.replace(/[\s-]/g, '');
    if (!/^03[2-48]\d{7}$/.test(numeroNormalized)) {
      Alert.alert("Erreur", "Numéro MVola invalide. Format attendu: 034 XX XXX XX");
      return;
    }
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.summary}>
        ...
        <View style={styles.summaryRow}>
          ...
          <Text style={styles.value}>{reservationData.code_reservation || 'N/A'}</Text>
        </View>

        {/* ✅ CORRECTION ICI : Vérifier que voyage et trajet existent */}
        ...
        {/* ✅ CORRECTION : Afficher la date correctement */}
        ...
        {/* ✅ CORRECTION : Vérifier que places est un tableau */}
        ...
        <View style={styles.summaryRow}>
          ...
          <Text style={styles.totalValue}>
            {(reservationData.montant || 0).toLocaleString()} Ar
          </Text>
        </View>
      </View>
      ...
      <View style={styles.paymentSection}>
        ...
        <Text style={styles.helperText}>
          Format: 034, 033, 032 ou 038 suivi de 7 chiffres
        </Text>
      </View>
      ...
      >
        {loading ? (
          ...
          <Text style={styles.buttonText}>
            Payer {(reservationData.montant || 0).toLocaleString()} Ar
          </Text>
        )}
      </TouchableOpacity>

      <Text style={styles.securityText}>
        🔒 Paiement sécurisé par MVola
      </Text>
    </ScrollView>
  );
}
